...
class MyColor{
  ...
  static const Color lPrimaryColor = Color(0xffCD5520);
  static const Color appBarColor = primaryColor;
  static const Color cardBgColor = Color(0xffd6764b);
  static const Color fieldDisableBorderColor = Color(0xffCD5520);
  ...
  static const Color primaryColor           = Color(0xffCD5520);
  static const Color green                  = Color(0xffBFBFBF);
